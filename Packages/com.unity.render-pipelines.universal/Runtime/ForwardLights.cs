...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    public class ForwardLights
    {
        static class LightConstantBuffer
        {
            ...
            public static int _AdditionalLightsCustomData1;
        }
        ...
        Vector4[] m_AdditionalLightsCustomData1;
        ...
        internal ForwardLights(InitParams initParams)
        {
            ...
            else
            {
                ...
                LightConstantBuffer._AdditionalLightsCustomData1 = Shader.PropertyToID("_AdditionalLightsCustomData1");
                ...
                m_AdditionalLightsCustomData1 = new Vector4[maxLights];
        ...
        {
            UniversalRenderPipeline.InitializeLightConstants_Common(lights, lightIndex, out lightPos, out lightColor, out lightAttenuation, out lightSpotDir, out lightOcclusionProbeChannel, out additionalLightsCustomData1);
            lightLayerMask = 0;
            isSubtractive = false;
        ...
        {
            Vector4 lightPos, lightColor, lightAttenuation, lightSpotDir, lightOcclusionChannel, additionalLightsCustomData1;
            uint lightLayerMask;
            bool isSubtractive;
            InitializeLightConstants(lightData.visibleLights, lightData.mainLightIndex, out lightPos, out lightColor, out lightAttenuation, out lightSpotDir, out lightOcclusionChannel, out lightLayerMask, out isSubtractive, out additionalLightsCustomData1);
        ...
        void SetupAdditionalLightConstants(CommandBuffer cmd, ref RenderingData renderingData)
        {
            ...
            if (additionalLightsCount > 0)
            {
                    ...
                    for (int i = 0, lightIter = 0; i < lights.Length && lightIter < maxAdditionalLightsCount; ++i)
                    {
                        ...
                        if (lightData.mainLightIndex != i)
                        {
                            ...
                            InitializeLightConstants(lights, i,
                                ...
                                out data.layerMask, out _, out _);
                ...
                else
                {
                    for (int i = 0, lightIter = 0; i < lights.Length && lightIter < maxAdditionalLightsCount; ++i)
                    {
                        if (lightData.mainLightIndex != i)
                        {
                            InitializeLightConstants(
                                ...
                                out m_AdditionalLightsCustomData1[lightIter]);
                    ...
                    cmd.SetGlobalVectorArray(LightConstantBuffer._AdditionalLightsCustomData1, m_AdditionalLightsCustomData1);
                }
